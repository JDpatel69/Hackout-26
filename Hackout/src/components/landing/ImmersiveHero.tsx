    ...
    <MotionConfig reducedMotion="user">
      <section className="tl-hero" aria-label="TerraLedger — verified climate impact">
        ...
        <div className="tl-hero__cards">
          ...
          <FloatCard
            slotClass="tl-card-slot--chip"
            px={chipX}
            py={chipY}
            delay={1.35}
            float={{ range: [0, -6, 0], dur: 6.5, delay: 0.3 }}
          >
            <article className="tl-card tl-chip">
              <span className="tl-chip__pulse" aria-hidden="true" />
              <div>
                <b>184 farms verified</b>
                <small>Active across 11 regions</small>
              </div>
            </article>
          </FloatCard>
        </div>
